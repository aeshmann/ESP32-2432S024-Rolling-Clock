...
{
  Serial.printf("%s = %d", label, val);
}

/*-------- TIME SERVER ----------*/
// NTP Servers:
static const char ntpServerName[] = "0.ru.pool.ntp.org";
...
TimeChangeRule myStandardTime = {"MSK", First, Sun, Nov, 2, 3 * 60};
TimeChangeRule myDaylightSavingsTime = {"MSK", Second, Sun, Mar, 2, 3 * 60};
